...
export class LCSCParser extends BaseParser {
    constructor() {
        super('LCSC', 'https://www.lcsc.com');
    }

    async search(query) {
        try {
            console.log(`🔍 LCSC поиск: ${query}`);
            ...
            console.error(`❌ Ошибка LCSC поиска:`, error.message);
            return [];
        }
    }
}

export default new LCSCParser();
