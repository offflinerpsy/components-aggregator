...
export class FutureParser extends BaseParser {
    constructor() {
        super('Future', 'https://www.futureelectronics.com');
    }

    async search(query) {
        try {
            console.log(`🔍 Future поиск: ${query}`);
            ...
            console.error(`❌ Ошибка Future поиска:`, error.message);
            return [];
        }
    }
}

export default new FutureParser();
